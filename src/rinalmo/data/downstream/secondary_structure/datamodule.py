...
from src.rinalmo.data.downstream.secondary_structure.dataset import SecondaryStructureDataset

from src.rinalmo.utils.download import download_spot_rna_bprna, download_archiveII_fam_splits
...
class SecondaryStructureDataModule():
    def __init__(
        self,
